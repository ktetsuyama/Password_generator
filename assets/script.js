...
function generatePassword() {
	...
	var choicesLow = confirm("Would you like to include Lower case letters in your password? \n\n(hint: a variety of different characters, including lower case letters helps create a more secure password.)");

	if (choicesLow) {
		alert("Thank you. \nYour password will include lower case letters.  Please choose another criteria after clicking 'Ok'.");
	} else {
	...
	var choicesNum = confirm("Would you like to include numerical digits in your password? \n\n(hint: a variety of different characters, including numerical digits helps create a more secure password.)");

	if (choicesNum) {
		alert("Thank you. \nYour password will include numerical digits. Please choose another criteria after clicking 'Ok'.");
	} else {
